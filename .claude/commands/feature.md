...
- `src/**` - Contains backend code (processors, db, pipelines, storage, llm, validation).
- `frontend/**` - Contains the React/Vite frontend client.
- `config/**` - Contains configuration files.
- `scripts/**` - Contains the scripts to start and stop services.
...
- `uv run pytest test/` - Run backend tests to validate the feature works with zero regressions
- `cd frontend && npm run typecheck` - Run frontend type checks to validate the feature works with zero regressions
- `cd frontend && npm run build` - Run frontend build to validate the feature works with zero regressions
